...
namespace CoreTest
{
    ...
    public class TestUpdatePackage
    {
        ...
        #region First InfoUpdate
        [TestMethod]
        public void InfoUpdate0_ZeroInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(0, 0));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
            Vector2[] expected = new Vector2[2] {new Vector2(0,0), new Vector2(0,0)};
            CollectionAssert.AreEqual(expected, actual);
        }

        [TestMethod]
        public void InfoUpdate0_OneInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(1, 1));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
            Vector2[] expected = new Vector2[2] {new Vector2(1,1), new Vector2(0,0)};
            CollectionAssert.AreEqual(expected, actual);
        }

        [TestMethod]
        public void InfoUpdate0_MinusOneInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(-1, -1));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
        ...
        [TestMethod]
        public void InfoUpdate0_MaxInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(float.MaxValue, float.MaxValue));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
            Vector2[] expected = new Vector2[2] {new Vector2(float.MaxValue,float.MaxValue), new Vector2(0,0)};
            CollectionAssert.AreEqual(expected, actual);
        }

        [TestMethod]
        public void InfoUpdate0_MinInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(float.MinValue, float.MinValue));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
            Vector2[] expected = new Vector2[2] {new Vector2(float.MinValue, float.MinValue), new Vector2(0,0)};
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        #region Second InfoUpdate
        [TestMethod]
        public void InfoUpdate1_ZeroInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(0, 0), new Vector2(0, 0));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
            Vector2[] expected = new Vector2[2] {new Vector2(0,0), new Vector2(0,0)};
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        [TestMethod]
        public void InfoUpdate1_OneInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
        ...
        [TestMethod]
        public void InfoUpdate1_MinInput()
        {
            UpdatePackage test = new UpdatePackage(Vector2.Zero);
            test.InfoUpdate(new Vector2(float.MinValue, float.MinValue), new Vector2(float.MinValue, float.MinValue));
            Vector2[] actual = new Vector2[2] {test.position, test.velocity};
            Vector2[] expected = new Vector2[2] {new Vector2(float.MinValue, float.MinValue), new Vector2(float.MinValue, float.MinValue) };
            CollectionAssert.AreEqual(expected, actual);
        }
