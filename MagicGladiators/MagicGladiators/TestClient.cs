                ...
                switch (msgIn.MessageType)
                {
                    ...
                    case NetIncomingMessageType.Data:
                        ...
                        if (type == (byte)PacketType.Push)
                        {
                            ...
                            float x = msgIn.ReadFloat();
                            float y = msgIn.ReadFloat();
                            (GameWorld.Instance.player.GetComponent("Player") as Player).isPushed(new Vector2(x, y) * ( 2 + GameWorld.Instance.player.CurrentHealth / GameWorld.Instance.player.MaxHealth));
