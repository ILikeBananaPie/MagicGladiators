...
namespace MagicGladiators
{
    ...
    public class GameWorld : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            string[] testItem = new string[] { "Speed", "0", "0.05", "0", "0", "100", "0", "0", "0", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
            testItem = new string[] { "Hp", "10", "0", "0", "0", "100", "0", "0", "0", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
            testItem = new string[] { "LavaRes", "0", "0", "0", "-0.05", "100", "0", "0", "0", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
            testItem = new string[] { "DmgRes", "0", "0", "-0.05", "0", "100", "0", "0", "0", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
            testItem = new string[] { "KnockRes", "0", "0", "0", "0", "100", "0.05", "0", "0", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
            testItem = new string[] { "ProjectileSpeed", "0", "0", "0", "0", "100", "0", "0.05", "0", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
            testItem = new string[] { "LifeSteal", "0", "0", "0", "0", "100", "0", "0", "0.05", "0" };
            itemList.Add(director.ConstructItem(new Vector2(50, 50), testItem));
