...
namespace MagicGladiators
{
    interface IBuilder
    {
        ...
        void BuildIcon(Vector2 position, string name, int value, string text);
        void FireProjectile(Vector2 position, Vector2 targetVector, string ability, GameObject shooter, string id);
